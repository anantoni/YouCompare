...
*/
		...
		public function add_attribute ( $attr_info, $category_id )												
		{
			...
			if ( ( $err = $this->insert_depending_comparability ( $attr_info ) ) != DB_OK )						//	insert in the other tables related to attribute
			{							
				$this->errno = $err;																					
				return ;
			}
...
*/	
		...
		private function insert_depending_comparability ( $attr_info )											
		{
