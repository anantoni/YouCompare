...
////////////////////////////////////////////////////////////////////////////////
        ...
        for($i=0;$i<$attrnum;$i++){
			...
			if(!empty($_REQUEST["attr"][$i])){
				if(!is_numeric($_REQUEST["attr"][$i])){
					header("Location: ./manageEntities.php?cat_id=".$catid."&mode=17");
					return;
				}
			}
			   ...
			   if(check_string($_REQUEST["attr"][$i], 0, 1)==BAD_INPUT)
